...
import iocingestor.sources.web


class TestWeb(unittest.TestCase):
    def setUp(self):
        self.web = iocingestor.sources.web.Plugin(
            "myweb", "http://example.mock/list.txt"
        )
    ...
    def test_run_with_200(self):
        ...
        httpretty.register_uri(
            ...
            adding_headers={"Last-Modified": "test", "Etag": '"test"'},
        )
    ...
    def test_run_with_304(self):
        httpretty.register_uri(
            httpretty.HEAD, "http://example.mock/list.txt", status=304
        )
