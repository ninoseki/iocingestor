...
import iocingestor.exceptions
import iocingestor.sources.abstract_json


class TestJSON(unittest.TestCase):
    def setUp(self):
        self.abs_json = iocingestor.sources.abstract_json.AbstractPlugin("name", [], "")
    ...
    def test_run_uses_reference_path_if_possible(self):
        ...
        abs_json = iocingestor.sources.abstract_json.AbstractPlugin(
            "name", ["testContent"], "testRef"
        )
